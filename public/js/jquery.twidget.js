...
;( function( $, window, document, undefined ) {
    ...
    function Plugin ( element, options ) {
        ...
        if(this.settings.locale == 'es'){
            this.settings.localization = {
              avia_tab_caption: 'VUELO',
              hotel_tab_caption: 'HOTEL',
              avia_logo_caption: 'Vuelos y ticket de aerolíneas baratas',
              hotel_logo_caption: 'Buscar y comparar precios de hotel',
              avia_input_origin_label: 'Origen',
              avia_input_destination_label: 'Destino',
              hotel_input_destination_label: 'Ciudad o nombre de Hotel',
              hotels_count_caption_1: 'hotel',
              hotels_count_caption_2: 'hoteles',
              hotels_count_caption_5: 'hoteles',
              avia_input_date_start: 'Fecha de Partida',
              avia_input_date_end: 'Fecha de Regreso',
              hotel_input_date_start: 'Check In',
              hotel_input_date_end: 'Check Out',
              avia_passengers_select_caption: 'Pasajeros/Clases',
              hotel_guests_select_caption: 'Visitas',
              avia_passengers_caption_1: 'pasajero',
              avia_passengers_caption_2: 'pasajeros',
              avia_passengers_caption_5: 'pasajeros',
              hotel_guests_caption_1: 'visita',
              hotel_guests_caption_2: 'visitas',
              hotel_guests_caption_5: 'visitas',
              avia_passengers_select_adults: 'Adultos',
              avia_passengers_select_children: 'Niños de hasta 12<br>años',
              ...
              hotel_submit_button_text: 'Busqueda',
              avia_all_airports_caption: 'Todos los aeropuertos',
              ...
              hotel_logo_link: 'https://hotellook.com/',
              avia_submit_domain : 'https://www-amer.epower.amadeus.com/columbiatours/'
            };
        }
    ...
    $.extend( Plugin.prototype, {
        init: function() {
            ...
            if(this.settings.locale == 'en') {
                ...
                container.find('input[name="FlightType"]').remove();
            }

            /* flight vars */
            var origin_iata_input       = container.find('input[name="From"]'),
                destination_iata_input  = container.find('input[name="To"]'),
                oneway_input            = container.find('input[name="FlightType"]'),
                trip_class_input        = container.find('input[name="trip_class"]'),
                pas_count_label         = container.find('#twidget-pas'),
                adults_pas_input        = container.find('#twidget-passenger-form input[name="AdtCount"]'),
                children_pas_input      = container.find('#twidget-passenger-form input[name="ChdCount"]'),
                infants_pas_input       = container.find('input[name="InfCount"]'),
            /* hotel vars */
            ...
            $(document).on("click", "#"+this.element.id+" .twidget-q-btn", function() {
                ...
                container.find('#twidget-passenger-form input[name="AdtCount"], #twidget-passenger-form input[name="ChdCount"], input[name="InfCount"]').trigger('change');
                guests_count_label.html(0);
                container.find('#twidget-guest-form input[name="AdtCount"], #twidget-guest-form input[name="children_sum"]').trigger('change');
            });

            /* calculate passengers count label */
            container.find('#twidget-passenger-form input[name="AdtCount"], #twidget-passenger-form input[name="ChdCount"], input[name="InfCount"]').on('change', function() {
            ...
            container.find('#twidget-guest-form input[name="AdtCount"], #twidget-guest-form input[name="children_sum"]').on('change', function() {
            ...
            var dateSelect     = container.find('#twidget-flight-datepicker'),
                dateDepart     = container.find('input[name="DepartureDate"]'),
                dateReturn     = container.find('input[name="ReturnDate"]'),
            ...
            $.fn.datepicker.dates['es'] = {
                ...
                daysMin:["<span style='color: red;'>Do</span>","Lu","Ma","Mi","Ju","Vi","<span style='color: red;'>Sa</span>"],
        ...
        widget_html: function() {
            ...
            '                                    <input type="text" name="DepartureDate" placeholder="'+_this.settings.localization.avia_input_date_start+'">'+
            ...
            '                                    <input type="text" name="ReturnDate" placeholder="'+_this.settings.localization.avia_input_date_end+'" value="">'+
            '                                    <div class="twidget-icon-cal""></div>'+
            ...
            '                        </li>'+
            '                        <!-- oneway flag -->'+
            '                        <input type="hidden" name="FlightType" disabled value="0">'+
            '                        <!-- flight passengers -->'+
            ...
            '                                            <div class="twidget-cell twidget-age-select">'+
            '                                                <span class="twidget-dec twidget-q-btn" data-age="adults">-</span><span class="twidget-num"><input type="text" name="AdtCount" value="1"></span><span class="twidget-inc twidget-q-btn" data-age="adults">+</span>'+
            '                                            </div>'+
            '                                        </li>'+
            '                                        <li>'+
            '                                            <div class="twidget-cell twidget-age-name">' + _this.settings.localization.avia_passengers_select_children + '</div>'+
            '                                            <div class="twidget-cell twidget-age-select">'+
            '                                                <span class="twidget-dec twidget-q-btn" data-age="children">-</span><span class="twidget-num"><input type="text" name="ChdCount" value="0"></span><span class="twidget-inc twidget-q-btn" data-age="children">+</span>'+
            '                                            </div>'+
            '                                        </li>'+
            '                                        <li>'+
            '                                            <div class="twidget-cell twidget-age-name">' + _this.settings.localization.avia_passengers_select_infants + '</div>'+
            '                                            <div class="twidget-cell twidget-age-select">'+
            '                                                <span class="twidget-dec twidget-q-btn" data-age="infants">-</span><span class="twidget-num"><input type="text" name="InfCount" value="0"></span><span class="twidget-inc twidget-q-btn" data-age="infants">+</span>'+
            '                                            </div>'+
            '                                        </li>'+
            '                                    </ul>'+
            ...
            '                                            <div class="twidget-cell twidget-age-name">' + _this.settings.localization.avia_passengers_select_adults + '</div>'+
            '                                            <div class="twidget-cell twidget-age-select">'+
            '                                                <span class="twidget-dec twidget-q-btn" data-age="adults-g">-</span><span class="twidget-num"><input type="text" name="AdtCount" value="1"></span><span class="twidget-inc twidget-q-btn" data-age="adults-g">+</span>'+
            '                                            </div>'+
            '                                        </li>'+
            '                                        <li>'+
