			...
			<div class="container">
				<div class="row">
					<div class="site-main col-sm-9 alignright">
						...
						<a href="<?php echo e(URL::action('PaquetesController@paquetedetalle',$promocion->id)); ?>">

											<img width="430" height="305" src="/img/<?php echo e($promocion->imagen_url); ?>" alt="" title="">
										</a>
									...
									<div class="wrapper_content">
										<div class="post_title"><h4>
											<a href="<?php echo e(URL::action('PaquetesController@paquetedetalle',$promocion->id)); ?>" rel="bookmark"><?php echo e($promocion->titulo); ?></a>
										</h4></div>
										<!--<span class="post_date">5 DAYS 4 NIGHTS</span>-->
										<div class="description">
											<p><?php echo e($promocion->descripcion); ?></p>
										</div>
									</div>
									<div class="read_more">
										...
										<a href="<?php echo e(URL::action('PaquetesController@paquetedetalle',$promocion->id)); ?>" class="read_more_button">VER MÁS
